...
for (let i = 0; i < (length - 1); i++) { 
  ...
  for (let j = 0; j < food_list.length; j++){
    ...
    if ( food_item.key == "Acai Bowl with Fruits"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/acai-bowl.jpg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "Masala Omlette"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/omelet.jpg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "Choco Pancakes with Stawberries"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/pancake.jpg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "Blueberry Smoothie"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/smoothie.jpg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "Sausage and Egg Sandwiches"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/sandwiches.jpg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "Black Bean soup"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/soup.jpg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "Chicken and Farro Salad"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/chickensalad.jpg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "Pot Beef Curry with Rice"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/beefcurry.jpeg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "Bolognese Pasta"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/bolognesepasta.jpeg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "Pork Lettuce Wraps"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/lettucewrap.jpeg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "Rainbow Sushi"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/ranbowsushi.jpg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "Stuffed Butternut Squash"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/stuffedbutternut.jpg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "Straberry and Cream Granola Bar"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/granola.jpg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "BLT Eggs"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/blt.jpg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "PB Choco Cookie"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/cookies.jpg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "Corn Zucchini Fritters"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/Fritterss.jpg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
    else if(food_item.key == "Prezel"){
        const food_image =`<div class = "images"><img src = "assets/mealimages/pretzel.jpg" class = "image"></img></div>`
        results.innerHTML += food_image
    }
